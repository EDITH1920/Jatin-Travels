...
import { FaCarSide, FaRoad, FaPlaneDeparture, FaBriefcase } from "react-icons/fa";

const serviceData = [
  { key: "local", icon: FaCarSide, title: "Local Rides", desc: "Fast and comfortable travel inside the city.", delay: 0 },
  { key: "outstation", icon: FaRoad, title: "Outstation Trips", desc: "Long-distance travel with comfort and safety.", delay: 150 },
  { key: "airport", icon: FaPlaneDeparture, title: "Airport Pickup & Drop", desc: "On-time airport transfers.", delay: 300 },
  { key: "corporate", icon: FaBriefcase, title: "Corporate Travel", desc: "Dedicated corporate cab service.", delay: 450 },
];
...
export default function Services({ openBookingModal }) {
  ...
  useEffect(() => {
    ...
    cards.forEach((card) => {
      card.addEventListener("mousemove", (e) => {
        ...
        const x = e.clientX - rect.left - 16; // center glow
  ...
  return (
    <section id="services" className="bg-[#0F0F17] text-white py-28 px-6 sm:px-10 relative overflow-hidden">
            ...
            return (
              ...
              >
                ...
                <div className="service-card bg-[#151522]/60 backdrop-blur-2xl rounded-2xl p-10 h-full transition-all duration-500 hover:shadow-[0_25px_60px_rgba(255,106,0,0.25)]">
                  ...
                  {/* Book Button + Cursor Tracking */}
                  <div className="book-btn-group relative inline-block">
                    <button
                      onClick={() => openBookingModal && openBookingModal(s.title)}
